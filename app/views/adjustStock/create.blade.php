	...
	<div class="col-lg-12">
	    ...
	    <div class="ibox-content">
			<div class="" style="margin-top: 10px">
				{{ Form::open(array('action'=>'adjustStock.create_physical', 'autocomplete'=>'off', 'method'=>'post','class'=>'form-horizontal')) }}
                    ...
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-2 control-label">{{Lang::get('adjuststock.select_wh_phy_stock')}} <span class="required">*</span></label>
                            <div class="col-md-4">
