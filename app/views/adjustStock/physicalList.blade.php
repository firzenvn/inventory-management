...
<div class="row">
	<div class="col-lg-12">
        <div class="ibox-title">
            <h5>{{ Lang::get('adjuststock.title_phy') }}</h5>
        </div>
        <div class="ibox-content">
        <div>
            <div class="clear">
                        <a href="{{ URL::route('adjuststock.list') }}" class="btn btn-sm btn-primary">Create</a>
            <div class="pull-right">
	                    <a class="btn btn-sm btn-default" href="{{ URL::route('adjuststock.list') }}">Reset</a>
		...
		<div style="margin-top: 10px">
				...
				@foreach($rows as $row)
					<tr>
						...
						<td>{{ $row->reasons }}</td>
						<td>
							<a href="{{ URL::route('adjuststock.add_product_phy.get',array('report_id'=>$row->id)) }}"><i class="fa fa-pencil-square-o"></i></a> |
							<a href="{{ URL::route(adjuststock) }}" onclick="return confirm('You sure?')"> <i class="fa fa-times"></i></a>
						</td>
					</tr>
				@endforeach
				</tbody>
