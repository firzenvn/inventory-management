{{Form::open(array('route'=>'client-users.list','method'=>'get'))}}
<div class="row">
	<div class="col-lg-12">
    		...
    		<!-- widget content -->
				...
				@foreach($rows as $row)
					<tr>
						...
						<td>
							<a href="{{ URL::route('client-users.update',array('id'=>$row->id)) }}"><i class="fa fa-pencil-square-o"></i></a> |
							<a href="{{ URL::route('client-users.delete',array('id'=>$row->id)) }}" onclick="return confirm('You sure?')"> <i class="fa fa-times"></i></a>
						</td>
					</tr>
				@endforeach
				</tbody>
