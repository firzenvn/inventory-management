<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-8">
        <h2>{{ Lang::get('orders.create_order') }}</h2>
    </div>
    <div class="col-lg-4">
...
{{ Form::open(array('route'=>'orders.create', 'autocomplete'=>'off', 'method'=>'post','class'=>'form-horizontal')) }}
<div class="wrapper wrapper-content animated fadeInRight">
                    ...
                    <div class="row">
                        <div class="col-sm-3 m-b-xs">
                            <label>
                                ...
                                {{ Form::select('status',Config::get('constant.order_status'),Input::get('status'),array('class'=>'form-control input-s-sm inline'))}}
                            </label>
                        </div>
	...
	<div class="row">
		<div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>{{Lang::get('users.account_information')}}</h5>
                    <div class="ibox-tools">
                        <a class="collapse-link">
                            <i class="fa fa-chevron-up"></i>
                        </a>
                ...
                <div class="ibox-content">
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-2 control-label">{{Lang::get('orders.search_customer')}} </label>
                            <div class="col-md-4 search-dropdown">
                                {{ Form::text('search_customer',Input::get('search_customer'),array('class'=>'form-control search-customer', 'id'=> 'search-customer'))}}
                                <ul class="search-ac">
                                    <li><a href="javascript: void(0)">{{Lang::get('orders.search_description')}}</a></li>
                                </ul>
                            </div>
                        </div>
                    </fieldset>
                ...
                <div class="ibox-content">
					<fieldset>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-8">
		                        {{ Form::text('billing_middle',Input::get('billing_middle'),array('class'=>'form-control customer_info cus_middle', 'disabled'))}}
		                    </div>
		                </div>
		                <div class="form-group">
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-8">
		                        {{ Form::text('billing_company',Input::get('billing_company'),array('class'=>'form-control customer_info cus_company','disabled' ))}}
		                    </div>
		                </div>
		                <div class="form-group">
	            ...
	            <div class="ibox-content">
					<fieldset>
	                    ...
	                    <div class="form-group">
	                        <label class="col-md-4 control-label">{{Lang::get('customer.middle')}}</label>
	                        <div class="col-md-8">
	                            {{ Form::text('shipping_middle',Input::get('shipping_middle'),array('class'=>'form-control customer_info cus_middle','disabled'))}}
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-md-4 control-label">{{Lang::get('customer.last_name')}} <span class="disabled">*</span></label>
	                    ...
	                    <div class="form-group">
	                        <label class="col-md-4 control-label">{{Lang::get('customer.company')}}</label>
	                        <div class="col-md-8">
	                            {{ Form::text('shipping_company',Input::get('shipping_company'),array('class'=>'form-control customer_info cus_company','disabled'))}}
	                        </div>
	                    </div>
	                    <div class="form-group">
	                        <label class="col-md-4 control-label">{{Lang::get('customer.address')}} <span class="disabled">*</span></label>
...
function addCustomerInfo(d){
	...
	$.each( data, function( key, val ) {
		$(".cus_" + key).val(val);
		if(key != 'id')
			$(".cus_" + key).prop('disabled', false);
	});
	$(".search-dropdown .search-ac").removeClass("active");
	$(".search-dropdown .search-ac").css("display","none");
}
