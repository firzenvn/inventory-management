	...
	<div class="col-lg-12">
		...
		<div class="ibox-content">
			<div class="" style="margin-top: 10px">
				{{ Form::open(array('action'=>'sendStock.create_sending', 'method'=>'post','class'=>'form-horizontal')) }}
				<fieldset>
					<div class="form-group">
						<label class="col-md-2 control-label">{{Lang::get('label.source_warehouse')}} <span class="required">*</span></label>
						<div class="col-md-4">
				...
				<fieldset>
					<div class="form-group">
						<label class="col-md-2 control-label">{{Lang::get('label.destination')}} <span class="required">*</span></label>
						<div class="col-md-4">
