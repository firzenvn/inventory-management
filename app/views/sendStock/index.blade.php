	...
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				{{Form::open(array('route'=>'sendStock.index','method'=>'get'))}}
				<div class="">
					<a href="{{URL::route('sendStock.create')}}" class="btn btn-primary">Create Send Stock</a>

					<div class="pull-right">
						<a class="btn btn-sm btn-default" href="{{URL::route('sendStock.default')}}">Reset</a>
				...
				<table class="table table-striped table-bordered table-hover dataTables-example" >
					...
					<tr>
						...
						<th nowrap >{{Lang::get('label.source_warehouse')}}</th>
						<th nowrap >{{Lang::get('label.destination')}}</th>
					...
					<tr role="row">
						...
						<td class="hasinput">
							{{Form::text('source_warehouse',Input::get('source_warehouse'),array('class'=>'form-control','placeholder'=>Lang::get('label.source_warehouse')))}}
						</td>
						<td class="hasinput">
							{{Form::text('destination_warehouse',Input::get('destination_warehouse'),array('class'=>'form-control','placeholder'=>Lang::get('label.destination')))}}
						</td>
						<td class="hasinput">
