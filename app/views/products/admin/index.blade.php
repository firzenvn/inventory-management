<div class="row">
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			...
			{{Form::open(array('route'=>'admin.products.list','method'=>'get'))}}
			<div class="">
				{{--<a href="{{ URL::route('admin.products.create') }}"  class="btn btn-primary">Create</a>--}}

				<div class="pull-right">
					<a class="btn btn-sm btn-default" href="{{URL::route('admin.products.list')}}">Reset</a>
			...
			<table class="table table-striped table-bordered table-hover dataTables-example" >
				...
				<tr>
					<th nowrap >
						{{Lang::get('label.id')}}
						<a href="{{URL::route('admin.products.list', array('sort' => 'id', 'order' => 'desc'))}}"><i class="fa fa-caret-up"></i></a>
						<a href="{{URL::route('admin.products.list', array('sort' => 'id', 'order' => 'asc'))}}"><i class="fa fa-caret-down"></i></a>
					</th>
				...
				<tr>
					...
					<td>
						<a href="{{URL::route('admin.products.update.get',array('id'=>$row->id))}}"> <i class="fa fa-pencil-square-o"></i>Edit</a>
						<a href="{{URL::route('admin.products.delete',array('id'=>$row->id))}}" onclick="return confirm('Are you sure you want to delete this row?')"> <i class="fa fa-times"></i>Delete</a>
					</td>
				</tr>
				@endforeach
