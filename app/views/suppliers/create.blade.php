	...
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				{{ Form::open(array('route'=>'suppliers.create', 'autocomplete'=>'off', 'method'=>'post','class'=>'form-horizontal')) }}
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							{{ Form::text('supplier_name','',array('placeholder'=>Lang::get('label.supplier_name'),'required','class'=>'form-control'))}}
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							{{ Form::text('supplier_person','',array('placeholder'=>Lang::get('label.supplier_person'),'required','class'=>'form-control'))}}
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							{{ Form::email('supplier_email','',array('placeholder'=>Lang::get('label.supplier_email'),'required','class'=>'form-control'))}}
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							{{ Form::text('fax','',array('placeholder'=>Lang::get('label.fax'),'class'=>'form-control'))}}
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							{{ Form::text('website','',array('placeholder'=>Lang::get('label.website'),'class'=>'form-control'))}}
						</div>
					</div>
					<div class="hr-line-dashed"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							{{ Form::textarea('description','',array('placeholder'=>Lang::get('label.description'),'class'=>'form-control'))}}
						</div>
					</div>
					<div class="hr-line-dashed"></div>
