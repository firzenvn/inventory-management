<div class="row">
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			...
			{{Form::open(array('route'=>'suppliers.list','method'=>'get'))}}
			<div class="">
				<a href="{{ URL::route('suppliers.create') }}" class="btn btn-primary ">Add a new row</a>
			...
			<table class="table table-striped table-bordered table-hover dataTables-example" >
				<thead>
					<tr>
						<th nowrap  style="width: 5%;">
							{{Lang::get('label.id')}}
							<a href="{{URL::route('suppliers.list', array('sort' => 'seq_no', 'order' => 'desc'))}}"><i class="fa fa-caret-up"></i></a>
							<a href="{{URL::route('suppliers.list', array('sort' => 'seq_no', 'order' => 'asc'))}}"><i class="fa fa-caret-down"></i></a>
						</th>
						<th nowrap >{{Lang::get('label.supplier_name')}}</th>
						<th nowrap >{{Lang::get('label.supplier_person')}}</th>
						<th nowrap >
							{{Lang::get('label.supplier_email')}}
							<a href="{{URL::route('suppliers.list', array('sort' => 'email', 'order' => 'desc'))}}"><i class="fa fa-caret-up"></i></a>
							<a href="{{URL::route('suppliers.list', array('sort' => 'email', 'order' => 'asc'))}}"><i class="fa fa-caret-down"></i></a>
						</th>
						<th nowrap >
							{{Lang::get('label.phone_no')}}
							<a href="{{URL::route('suppliers.list', array('sort' => 'phone_no', 'order' => 'desc'))}}"><i class="fa fa-caret-up"></i></a>
							<a href="{{URL::route('suppliers.list', array('sort' => 'phone_no', 'order' => 'asc'))}}"><i class="fa fa-caret-down"></i></a>
						</th>
						...
						<th style="width: 7%;">{{Lang::get('label.assign_product')}}</th>
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="{{URL::route('suppliers.product-supplier.get',array('supplier_id'=>$row->id))}}">Product</a></td>
					<td>
						<a href="{{URL::route('suppliers.update.get',array('id'=>$row->id))}}"> Edit</a> |
						<a href="{{URL::route('suppliers.delete',array('id'=>$row->id))}}" onclick="return confirm('Are you sure you want to delete this row?')"> Delete</a>
					</td>
				</tr>
				@endforeach
			</tbody>
