	...
	<div class="col-lg-12">
		...
		<div class="ibox-content">
			<div class="" style="margin-top: 10px">
				{{ Form::open(array('action'=>'requestStock.add_detail.post', 'autocomplete'=>'off', 'method'=>'post','class'=>'form-horizontal')) }}
				{{ Form::hidden('request_id',Input::get('request_id')) }}
				...
				<fieldset>
					<div class="panel-heading">
						<h5 style="border-bottom: 1px solid #ccc">Stock Request Infomation</h5>
					</div>
					...
					<div class="form-group">
						<label class="col-md-2 control-label">{{Lang::get('label.reasons_for_request_stock')}} <span class="required">*</span></label>
						<div class="col-md-4">
							{{ Form::textarea('reasons',isset($model->reasons)?$model->reasons:'',array('placeholder'=>Lang::get('label.reasons_for_request_stock'),'required','class'=>'form-control')) }}
						</div>
					</div>
					<div class="panel-heading">
						<h5 style="border-bottom: 1px solid #ccc">Import Products to Request Stock</h5>
					</div>
					<div class="panel-heading" id="order-items">
						<div class="row">
							...
							<div class="col-lg-9">
								If you want to request stock from a warehouse by importing loads of products, the structure of CSV file is as follows:
					...
					<div class="panel-heading">
						<h5 style="border-bottom: 1px solid #ccc">Choose Products to Request Stock</h5>
					</div>
					<div class="panel-heading">
					...
					<div>
						<table class="table table-bordered">
							...
							<tr role="row">
								...
								<td class="hasinput">
									{{Form::text('total_qty_from',Input::get('total_qty_from')['from'],array('class'=>'form-control','id'=>'total_qty_from','placeholder'=>'From'))}}
									{{Form::text('total_qty_to',Input::get('total_qty_to')['to'],array('class'=>'form-control','id'=>'total_qty_to','placeholder'=>'To'))}}
								</td>
								<td class="hasinput">
								</td>
							</tr>
