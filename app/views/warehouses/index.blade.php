<div class="row">
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			...
			{{Form::open(array('route'=>'warehouse.list','method'=>'get'))}}
			<div class="">
				<a href="{{ URL::route('warehouse.create') }}"  class="btn btn-primary">Create</a>
				<div class="pull-right">
					<a class="btn btn-sm btn-default" href="{{URL::route('warehouse.list')}}">Reset</a>
			...
			<table class="table table-striped table-bordered table-hover dataTables-example" >
				...
				<tr>
					<th>
						{{Lang::get('label.id')}}
						<a href="{{URL::route('warehouse.list', array('sort' => 'seq_no', 'order' => 'desc'))}}"><i class="fa fa-caret-up"></i></a>
						<a href="{{URL::route('warehouse.list', array('sort' => 'seq_no', 'order' => 'asc'))}}"><i class="fa fa-caret-down"></i></a>
					</th>
					<th>{{Lang::get('label.name')}}</th>
					<th>{{Lang::get('label.manager_name')}}</th>
					<th>
						{{Lang::get('label.manager_email')}}
						<a href="{{URL::route('warehouse.list', array('sort' => 'manager_email', 'order' => 'desc'))}}"><i class="fa fa-caret-up"></i></a>
						<a href="{{URL::route('warehouse.list', array('sort' => 'manager_email', 'order' => 'asc'))}}"><i class="fa fa-caret-down"></i></a>
					</th>
					<th>
						{{Lang::get('label.phone_no')}}
						<a href="{{URL::route('warehouse.list', array('sort' => 'phone_no', 'order' => 'desc'))}}"><i class="fa fa-caret-up"></i></a>
						<a href="{{URL::route('warehouse.list', array('sort' => 'phone_no', 'order' => 'asc'))}}"><i class="fa fa-caret-down"></i></a>
					</th>
				...
				<tr>
					...
					<td>
						<a href="{{URL::route('warehouse.update.get',array('id'=>$row->id))}}"><i class="fa fa-pencil-square-o"></i> Edit</a>
						<a href="{{URL::route('warehouse.delete',array('id'=>$row->id))}}" onclick="return confirm('You sure?')"> <i class="fa fa-times"></i>Delete</a>
					</td>
				</tr>
				@endforeach
