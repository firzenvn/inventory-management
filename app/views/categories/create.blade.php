<div class="row">
	<div class="col-lg-12">
		<div class="ibox float-e-margins">
			...
			{{ Form::open(array('route'=>'categories.create', 'autocomplete'=>'off', 'method'=>'post','class'=>'form-horizontal')) }}
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					{{ Form::text('name','',array('placeholder'=>Lang::get('label.category_name'),'required','class'=>'form-control'))}}
				</div>
			</div>

			<div class="form-group">
				<label class="col-md-2 control-label">{{Lang::get('label.category_description')}}</label>
				<div class="col-md-4">
					{{ Form::textarea('description','',array('placeholder'=>Lang::get('label.category_description'),'class'=>'form-control'))}}
				</div>
			</div>
