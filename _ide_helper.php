...
namespace {
    ...
    class Authority extends \mnshankar\RoleBasedAuthority\Facades\Authority{
         ...
         * @static 
         */
        public static function dispatch($eventName, $payload = array()){
            return \Authority\Authority::dispatch($eventName, $payload);
        }
         ...
         * @static 
         */
        public static function can($action, $resource, $resourceValue = null){
            return \Authority\Authority::can($action, $resource, $resourceValue);
        }
         ...
         * @static 
         */
        public static function cannot($action, $resource, $resourceValue = null){
            return \Authority\Authority::cannot($action, $resource, $resourceValue);
        }
         ...
         * @static 
         */
        public static function allow($action, $resource, $condition = null){
            return \Authority\Authority::allow($action, $resource, $condition);
        }
         ...
         * @static 
         */
        public static function deny($action, $resource, $condition = null){
            return \Authority\Authority::deny($action, $resource, $condition);
        }
         ...
         * @static 
         */
        public static function addRule($allow, $action, $resource, $condition = null){
            return \Authority\Authority::addRule($allow, $action, $resource, $condition);
        }
         ...
         * @static 
         */
        public static function addAlias($name, $actions){
            return \Authority\Authority::addAlias($name, $actions);
        }
        ...
        public static function setCurrentUser($currentUser){
            \Authority\Authority::setCurrentUser($currentUser);
        }
         ...
         */
        public static function setDispatcher($dispatcher){
            \Authority\Authority::setDispatcher($dispatcher);
        }
        
        /**
         * Returns all rules relevant to the given action and resource
         *
         * @return \Authority\RuleRepository 
         * @static 
         */
        public static function getRulesFor($action, $resource){
            return \Authority\Authority::getRulesFor($action, $resource);
        }
        ...
        public static function getRules(){
            return \Authority\Authority::getRules();
        }
         ...
         * @static 
         */
        public static function getAliasesForAction($action){
            return \Authority\Authority::getAliasesForAction($action);
        }
        ...
        public static function getAliases(){
            return \Authority\Authority::getAliases();
        }
        ...
        public static function getAlias($name){
            return \Authority\Authority::getAlias($name);
        }
        ...
        public static function getCurrentUser(){
            return \Authority\Authority::getCurrentUser();
        }
